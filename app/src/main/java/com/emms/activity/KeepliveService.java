...
public class KeepLiveService extends Service {
    ...
    public void onCreate() {
        ...
        try {
            mStartForeground = KeepLiveService.class.getMethod("startForeground", mStartForegroundSignature);
            mStopForeground = KeepLiveService.class.getMethod("stopForeground", mStopForegroundSignature);
            ...
            timerTask=new TimerTask() {
                ...
                public void run() {
                    ...
                    if(AppApplication.KeepLive) {
                        ServiceUtils.starKeepLiveService(ServiceUtils.Mode.Only_KeepLiveServiceNo_2, getApplicationContext());
                    }
                }
            };
