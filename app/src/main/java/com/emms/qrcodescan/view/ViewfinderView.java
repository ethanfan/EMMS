...
package com.emms.qrcodescan.view;
...
public final class ViewfinderView extends View
{
    ...
    public void onDraw(Canvas canvas) {
        ...
        else
        {
            ...
            mPaint.setTextSize(TEXT_SIZE * density);
            mPaint.setAlpha(0x40);
            //mPaint.setTextAlign(Paint.Align.LEFT);
            mPaint.setTypeface(Typeface.create("System", Typeface.BOLD));
            String testString= getResources().getString(R.string.msg_default_status);
            StaticLayout layout=new StaticLayout(testString, mPaint, frame.right - frame.left, Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, true);
//            canvas.drawText(
//                    getResources().getString(R.string.msg_default_status),
//                    frame.left, frame.bottom + TEXT_PADDING_TOP * density,
//                    mPaint);
            canvas.translate(frame.left, (float) (frame.bottom + TEXT_PADDING_TOP * density));
            layout.draw(canvas);
